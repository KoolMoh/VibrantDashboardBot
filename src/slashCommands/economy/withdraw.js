    ...
    if (amount == "all") {
      if (data.bank < 1)
        return interaction.reply({
          ...
          content: `<:no:914527497352257557> you don't have any coins to withdraw`,
          ephemeral: true,
        });
      // update db
      let smth = data.bank;
      ...
      return interaction.reply({
        ...
        embeds: [
          {
            color: "#277ECD",
            description: `<:yes:914527497574567966> you have successfully withdrawn ${smth} :coin:`,
            author: {
        ...
        if (Number(amount) > 0) {
          ...
          if (Number(amount) <= data.bank) {
              ...
              embeds: [
                {
                  ...
                  description: `<:yes:914527497574567966> you have successfully withdrawn ${Number(
                    amount
                  )} :coin:`,
                  color: "#277ECD",
                },
            ...
            return interaction.reply({
              ephemeral: true,
              content:
                "<:no:914527497352257557> you don't have enough coins to withdraw",
              allowedMentions: {
                repliedUser: false,
              },
            });
